...
import net.mcreator.yttdmod.network.VersocartaButtonMessage;
...
public class VersocartaScreen extends AbstractContainerScreen<VersocartaMenu> {
	private final static HashMap<String, Object> guistate = VersocartaMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public VersocartaScreen(VersocartaMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("yttd_mod:textures/screens/versocarta.png");
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 7, this.topPos + 142, 35, 20, Component.literal("<-"), e -> {
			if (true) {
				YttdModMod.PACKET_HANDLER.sendToServer(new VersocartaButtonMessage(0, x, y, z));
				VersocartaButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
