...
import net.mcreator.yttdmod.network.VCSacrificioButtonMessage;
...
public class VCSacrificioScreen extends AbstractContainerScreen<VCSacrificioMenu> {
	private final static HashMap<String, Object> guistate = VCSacrificioMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public VCSacrificioScreen(VCSacrificioMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("yttd_mod:textures/screens/vc_sacrificio.png");
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 7, this.topPos + 142, 35, 20, Component.literal("<-"), e -> {
			if (true) {
				YttdModMod.PACKET_HANDLER.sendToServer(new VCSacrificioButtonMessage(0, x, y, z));
				VCSacrificioButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
