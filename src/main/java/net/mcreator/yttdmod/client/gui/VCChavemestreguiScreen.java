...
import net.mcreator.yttdmod.network.VCChavemestreguiButtonMessage;
...
public class VCChavemestreguiScreen extends AbstractContainerScreen<VCChavemestreguiMenu> {
	private final static HashMap<String, Object> guistate = VCChavemestreguiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public VCChavemestreguiScreen(VCChavemestreguiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("yttd_mod:textures/screens/vc_chavemestregui.png");
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 7, this.topPos + 142, 35, 20, Component.literal("<-"), e -> {
			if (true) {
				YttdModMod.PACKET_HANDLER.sendToServer(new VCChavemestreguiButtonMessage(0, x, y, z));
				VCChavemestreguiButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
