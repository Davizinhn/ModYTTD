...
public class LixaguiScreen extends AbstractContainerScreen<LixaguiMenu> {
	private final static HashMap<String, Object> guistate = LixaguiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public LixaguiScreen(LixaguiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("yttd_mod:textures/screens/lixagui.png");
